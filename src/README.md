...
| GET    | `/announcements/active`                                           | Get active announcements for the public banner                      |
...
Data is stored in MongoDB and initialized with example content when collections are empty.
